...
- **گواهی CA سفارشی:** اختیاری؛ برای اتصال استاندارد خالی بگذارید. فقط برای CA اختصاصیِ مورد اعتماد، مسیر PEM را وارد کنید
...
certs/                     گواهی تاریخی؛ در بسته جدید توزیع یا فعال نمی‌شود
...
- اعتماد استاندارد TLS پیش‌فرض است؛ گواهی سفارشی واقعاً اختیاری است و بررسی TLS هرگز خاموش نمی‌شود.
- مسیر گواهی همراه نسخه قبلی، برای Endpoint قبلی یک‌بار پاک می‌شود؛ سایر CAهای سفارشی حفظ می‌شوند. پس از ارتقا تنظیمات را ذخیره کنید.
- Helper جدید علاوه بر لینک current، پوشه Release فعال Kitsu و فهرست pip freeze را در هر دو آرشیو نگه می‌دارد. بعد از ارتقا «نصب/آپدیت Helper» را بزنید.
- این آرشیو Image کامل دیسک نیست؛ pip freeze خودِ بسته‌های نصب نیست و نصب مجدد ممکن است به اینترنت نیاز داشته باشد.
- هنگام تهیه مجموعه بازیابی، نوشتن/آپلود کاربران را متوقف کنید؛ بکاپ دیتابیس و S3 تراکنش مشترک ندارند. بکاپ‌ها را تغییر ندهید: فایل‌های Hard-link ممکن است بین نسخه‌ها مشترک باشند.
